...
//
// Status: pre-alpha scaffold. The type spine below is stable and matches the
// design; implementations land next, starting with the math + curve kernel.
// See ai/DESIGN.md for the full design and roadmap.
