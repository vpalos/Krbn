# Mesh / organ regime (deferred — Phase 2)

This directory is intentionally a placeholder. The mesh-based feature source for
organic/scanned geometry is **roadmapped, not lost**: because everything from the
